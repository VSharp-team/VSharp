...
//            let state, this, thisIsNotNull = itp.FormInitialState ilmm
//            let initialState =
//                match this with
//                | None -> state
//                | Some _ -> WithPathCondition state thisIsNotNull
//            initialState, this
//
...
//        | Some itp ->
//            let ilmm = itp.MakeMethodIdentifier m
//            // TODO: merge it with kbatoev's edits
//            __notImplemented__()
...
//            let state, this, thisIsNotNull = x.FormInitialState ilmm
//            let initialState =
//                match this with
//                | None -> state
//                | Some _ -> WithPathCondition state thisIsNotNull
